export const es = {
  ...
  dashboard: {
    ...
    chatTitle: 'Asistente European Youth Together',
    chatSubtitle: 'Pregunta sobre la convocatoria Youth Together 2026',
  ...
  guides: {
    ...
    subtitle: 'Instrucciones para preparar la propuesta European Youth Together 2026',
    ...
    guide1Steps: [
      ...
      'Este PIC es necesario para participar en la convocatoria Youth Together 2026.',
    ],
    ...
    guide4Title: 'Checklist European Youth Together 2026',
    guide4Steps: [
      ...
      '✅ Envío antes del 26 de febrero de 2026.',
    ],
    guide5Title: 'Sobre la convocatoria European Youth Together 2026',
    guide5Steps: [
      'Acción KA3 — Apoyo a la reforma de políticas (ERASMUS-YOUTH-2026-YOUTH-TOG).',
      'Plazo de presentación: 26 de febrero de 2026.',
      'Objetivo: crear redes de cooperación transnacional para jóvenes en Europa.',
      'Participantes elegibles: organizaciones juveniles (ONGs, entidades públicas) de estados miembros de la UE y países asociados.',
      'Se requieren asociaciones transnacionales con socios de varios países.',
      'Las actividades incluyen intercambios, formaciones y proyectos conjuntos presenciales y online.',
      'Consultar la Guía del Programa Erasmus+ 2026 para detalles de financiación.',
    ],
    link1: 'Portal Funding & Tenders',
    link2: 'Guía del Programa Erasmus+ 2026',
    link3: 'Participant Register',
    link4: 'SEPIE (Agencia Nacional España)',
    link5: 'Convocatoria Youth Together 2026',
  },
  chat: {
